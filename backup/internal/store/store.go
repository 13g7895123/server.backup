...
func (s *Store) migrate(ctx context.Context) error {
	for _, name := range []string{"001_init.sql", "002_project_details.sql", "003_add_db_password.sql", "004_syslogs_gcp.sql", "005_run_tracking.sql", "006_syslog_source_type.sql"} {
